...
<body>
    ...
    <hr class="container">
    <form action="{{ route('product.substract') }}" method="POST">
        @csrf
        <div>
            ...
            <div>
                <input type="text" name="status" style="border: none; color: white" readonly value="keluar"  >
            </div>
        </div>
        ...
        <div class="submit container d-flex justify-content-end">
            <button class="btn btn-primary" type="submit">Keluarkan</button>
        </div>
    </form>
